...
MC_EXECUTABLE_SEND="send"
MC_EXECUTABLE_SEND_PATH="${MC_PARENT_DIR}/bin/${MC_EXECUTABLE_SEND}"
...
read -r -d '' MC_EXECUTABLE_SEND_CONTENTS << EOF
#!/bin/bash
# ${MC_EXECUTABLE_SEND_PATH} Generated by ${MC_SYSTEMD_SERVICE_NAME}
